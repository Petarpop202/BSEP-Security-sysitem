...
insert into users (name, surname, gender, username, password, jmbg, enabled, blocked, mail, phone_number, address_id, request_approved) values ('Danilo', 'Managerovic', 0, 'humanResourceManager', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', '123456789123', true, false, 'bsepNoReply@gmail.com', '065/123-456', 1, true);
insert into users (name, surname, gender, username, password, jmbg, enabled, blocked, mail, phone_number, address_id, request_approved) values ('Stefan', 'Inzenjer', 0, 'engineer', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', '123456789123', true, false, 'najdobarsrb@gmail.com', '065/123-456', 2, true);
insert into users (name, surname, gender, username, password, jmbg, enabled, blocked, mail, phone_number, address_id, request_approved) values ('Petar', 'Managerovic', 0, 'projectManager', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', '123456789123', true, false, 'pls1@gmail.com', '065/123-456', 2, true);
insert into users (name, surname, gender, username, password, jmbg, enabled, blocked, mail, phone_number, address_id, request_approved) values ('Admin', 'Adminovic', 0, 'admin', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', '123456789123', true, false, 'bsepNoReplasdy@gmail.com', '065/123-456', 1, true);
insert into users (name, surname, gender, username, password, jmbg, enabled, blocked, mail, phone_number, address_id, request_approved) values ('guest', 'guest', 0, 'guest', '', '', true, false, '', '', 1, true);


-- DODAVANJE INZENJERA
insert into users (name, surname, gender, username, password, jmbg, enabled, blocked, mail, phone_number, address_id, request_approved) values ('Inzenjer1', 'Inzenjer', 0, 'engineer1', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', '123456789111', true, false, 'engineer1@gmail.com', '065/123-111', 3, true);
insert into users (name, surname, gender, username, password, jmbg, enabled, blocked, mail, phone_number, address_id, request_approved) values ('Inzenjer2', 'Inzenjer', 0, 'engineer2', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', '123456789222', true, false, 'engineer2@gmail.com', '065/123-222', 4, true);
insert into users (name, surname, gender, username, password, jmbg, enabled, blocked, mail, phone_number, address_id, request_approved) values ('Inzenjer3', 'Inzenjer', 0, 'engineer3', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', '123456789333', true, false, 'engineer3@gmail.com', '065/123-333', 5, true);
