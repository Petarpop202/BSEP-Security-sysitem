...
insert into users (name, surname, gender, username, password, jmbg, enabled, mail, phone_number, address_id, request_approved, mfa, blocked) values ('Danilo', 'Managerovic', 0, 'humanResourceManager', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', '123456789123', true, 'bsepNoReply@gmail.com', '065/123-456', 1, true, false, false);
insert into users (name, surname, gender, username, password, jmbg, enabled, mail, phone_number, address_id, request_approved, mfa, blocked) values ('Stefan', 'Inzenjer', 0, 'engineer', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', '123456789123', true, 'pls@gmail.com', '065/123-456', 2, true, false, false);
insert into users (name, surname, gender, username, password, jmbg, enabled, mail, phone_number, address_id, request_approved, mfa, blocked) values ('Petar', 'Managerovic', 0, 'projectManager', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', '123456789123', true, 'pls1@gmail.com', '065/123-456', 2, true, false, false);
insert into users (name, surname, gender, username, password, jmbg, enabled, mail, phone_number, address_id, request_approved, mfa, blocked) values ('Admin', 'Adminovic', 0, 'admin', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', '123456789123', true, 'bsepNoReplasdy@gmail.com', '065/123-456', 1, true, false, false);
insert into users (name, surname, gender, username, password, jmbg, enabled, mail, phone_number, address_id, request_approved, mfa, blocked) values ('guest', 'guest', 0, 'guest', '', '', true, '', '', 1, true, false, false);


-- DODAVANJE INZENJERA
insert into users (name, surname, gender, username, password, jmbg, enabled, mail, phone_number, address_id, request_approved, mfa, blocked) values ('Inzenjer1', 'Inzenjer', 0, 'engineer1', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', '123456789111', true, 'engineer1@gmail.com', '065/123-111', 3, true, false, false);
insert into users (name, surname, gender, username, password, jmbg, enabled, mail, phone_number, address_id, request_approved, mfa, blocked) values ('Inzenjer2', 'Inzenjer', 0, 'engineer2', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', '123456789222', true, 'engineer2@gmail.com', '065/123-222', 4, true, false, false);
insert into users (name, surname, gender, username, password, jmbg, enabled, mail, phone_number, address_id, request_approved, mfa, blocked) values ('Inzenjer3', 'Inzenjer', 0, 'engineer3', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', '123456789333', true, 'engineer3@gmail.com', '065/123-333', 5, true, false, false);
