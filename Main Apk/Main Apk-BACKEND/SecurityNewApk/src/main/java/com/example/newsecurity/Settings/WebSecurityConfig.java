package com.example.newsecurity.Settings;

import com.example.newsecurity.Security.RestAuthenticationEntryPoint;
import com.example.newsecurity.Service.ServiceImplementation.CustomUserDetailsService;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    	...
    	http.authorizeRequests().antMatchers("/auth/**").permitAll()		// /auth/**
				...
				.antMatchers("/code/validate/key").permitAll()
			...
			.addFilterBefore(new com.example.newsecurity.Security.TokenAuthenticationFilter(tokenUtils,  userDetailsService()), BasicAuthenticationFilter.class);
